...
import { makeAdminApi, AdminTopupLog, Pagination } from '@/lib/api'
...
export default function AdminTopupLogsPage() {
  ...
  const [logs, setLogs] = useState<AdminTopupLog[]>([])
  ...
  const fetchLogs = useCallback(async () => {
    ...
    try {
      ...
      const result = await adminApi.getTopupLogs({ page, limit: PER_PAGE })
      setLogs(result.data)
  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-lg font-semibold text-gray-900">Topup Logs</h1>
        <button
          onClick={() => fetchLogs()}
          disabled={loading}
